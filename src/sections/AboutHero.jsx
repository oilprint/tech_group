...
const AboutHero = () => {
  return (
    <section
      id="about"
      className="relative bg-cover bg-no-repeat bg-center md:h-[80vh] h-[60vh] "
      style={{
      ...
      <div className="absolute z-10 -bottom-5 left-0 right-0 w-full md:h-[50vh] h-[30vh] bg-black-gradient-2"></div>
      ...
      <video
        ...
        muted
        loop
        className="video-hero absolute -z-1 bottom-0 left-0 right-0 top-0 w-full md:h-[80vh] h-[60vh] object-cover  opacity-75"
      />
