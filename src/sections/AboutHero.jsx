...
const AboutHero = () => {
  return (
    <section
      ...
      <div className="absolute z-10 -bottom-5 left-0 right-0 w-full h-[50vh] bg-black-gradient-2"></div>
      ...
      />
      <div className="container flex flex-1 justify-center items-center min-h-[80vh] z-1 relative">
